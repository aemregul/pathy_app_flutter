...
import 'package:pathy_app/bloc/onboarding/onboarding_cubit.dart';
import 'package:pathy_app/bloc/onboarding/onboarding_state.dart';
import 'package:pathy_app/bloc/theme/theme_cubit.dart';
import 'package:pathy_app/bloc/theme/theme_state.dart';
...
void main() {
  ...
  runApp(MultiBlocProvider(providers: [
    ...
    BlocProvider<AnimalCubit>(create: (context) => AnimalCubit()),
...
class _MainAppState extends State<MainApp> {
  ...
  void initState() {
    ...
    BlocProvider.of<AnimalCubit>(context).initAnimals();
    super.initState();
  }
